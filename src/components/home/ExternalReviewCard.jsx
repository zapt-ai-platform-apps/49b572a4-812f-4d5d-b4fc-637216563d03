...
export const ExternalReviewCard = ({ review }) => {
  const { author, rating, date, text, avatar, avatarRequest } = review;
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg h-full flex flex-col relative border-l-4 border-blue-500">
      {renderPlatformBadge()}
